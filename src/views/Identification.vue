  ...
  <main class="xl:h-screen xl:overflow-hidden">
    ...
    <div class="flex flex-col xl:flex-row">
      ...
      <div class="xl:w-1/2 bg-gray-200 flex">
        <div class="p-10 xl:p-15 2xl:p-20 xl:items-center">
          ...
          <form @submit.prevent="acceder">
            <div class="flex flex-col mb-5 lg:mb-10">
              <input type="text" id="nomEtPrenom" v-model="nomEtPrenom" placeholder="Votre nom et prénom" @input="validerNomEtPrenom" minlength="2" maxlength="50" class="border-teal-500 border-solid border-2 p-3 md:w-5/6 lg:w-3/4">
              <span v-if="!nomEtPrenomValid" class="text-red-500">{{ nomEtPrenomErreur}}</span>
            </div>
            <div class="flex flex-col mb-5 lg:mb-10">
              <input type="email" id="courriel" v-model="courriel" placeholder="Votre courriel" @input="validerCourriel" minlength="2" maxlength="100" class="border-teal-500 border-solid border-2 p-3 md:w-5/6 lg:w-3/4">
