<template>
      ...
      <div>
        <RouterLink to="/app/formulaireEntreprise" class="bg-blue-400 hover:bg-blue-500 hover:text-white text-gray-600 text-sm font-bold p-4 rounded-xl mb-16">Ajouter une entreprise</RouterLink>
